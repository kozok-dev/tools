...
echo .venv\Scripts\python main.py --auto-launch --fast fp16_accumulation cublas_ops autotune --use-sage-attention --enable-manager --enable-manager-legacy-ui> run.bat
